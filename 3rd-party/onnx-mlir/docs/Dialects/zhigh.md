...
### `zhigh.ExtendedLayoutTransform` (::onnx_mlir::zhigh::ZHighExtendedLayoutTransformOp)

_ZHigh Extended Layout Transform_

ZHigh operation fuse an extended sequence of layout transformation on a Z Tensor.
It expects a Z Tensor input, perform a onnx.LayoutTransform to CPU format, followed
by a onnx.Reshape function that split a shape dimension into two consecutive shapes,
followed by a onnxTranspose, followed by a onnx.Reshape that merges two consecutive
shapes into 1, followed by Layout transform to the "layout", or a conversion to float.

Data type is that of source. if dlf16_to_32, then input is expected in dlf16 and output
will be converted to f32.

There are specific constraints for this operation; they are currently listed in the
Verifier.
...
<table>
<tr><th>Attribute</th><th>MLIR Type</th><th>Description</th></tr>
<tr><td><code>reshape_split_axis</code></td><td>::mlir::IntegerAttr</td><td>64-bit signed integer attribute</td></tr>
<tr><td><code>reshape_split_factor</code></td><td>::mlir::IntegerAttr</td><td>64-bit signed integer attribute</td></tr>
<tr><td><code>transpose_pattern</code></td><td>::mlir::ArrayAttr</td><td>64-bit integer array attribute</td></tr>
<tr><td><code>reshape_merge_axis</code></td><td>::mlir::IntegerAttr</td><td>64-bit signed integer attribute</td></tr>
<tr><td><code>dlf16_to_f32</code></td><td>::mlir::BoolAttr</td><td>bool attribute</td></tr>
<tr><td><code>target_layout</code></td><td>::mlir::StringAttr</td><td>string attribute</td></tr>
</table>
...
| Result | Description |
| :----: | ----------- |
| `result` | tensor of 16-bit float or 32-bit float values or unranked tensor of 16-bit float values or 2D tensor of 16-bit float values with layout _2D or unranked tensor of 16-bit float values or 3D tensor of 16-bit float values with layout _3D or unranked tensor of 16-bit float values or 3D tensor of 16-bit float values with layout _3DS or unranked tensor of 16-bit float values or 4D tensor of 16-bit float values with layout _4D |
