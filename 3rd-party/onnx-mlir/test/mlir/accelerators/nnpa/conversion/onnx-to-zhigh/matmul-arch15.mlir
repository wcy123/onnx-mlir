...
func.func @test_onnx_to_transposeab_matmul_to_zhigh_3d(%arg0 : tensor<100x4x8xf32>, %arg1 : tensor<100x8x16xf32>) -> tensor<*xf32> {
  %0 = "onnx.Transpose"(%arg0) {perm = [0, 2, 1]}: (tensor<100x4x8xf32>) -> tensor<100x8x4xf32>
  %1 = "onnx.Transpose"(%arg1) {perm = [0, 2, 1]}: (tensor<100x8x16xf32>) -> tensor<100x16x8xf32>
...
// CHECK-DAG:       [[VAR_0_:%.+]] = "onnx.Transpose"([[PARAM_0_]]) <{perm = [0, 2, 1]}> : (tensor<100x4x8xf32>) -> tensor<100x8x4xf32>
// CHECK-DAG:       [[VAR_1_:%.+]] = "onnx.Transpose"([[PARAM_1_]]) <{perm = [0, 2, 1]}> : (tensor<100x8x16xf32>) -> tensor<100x16x8xf32>
