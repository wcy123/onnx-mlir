...
// CHECK:           "zlow.min"([[PARAM_0_]], [[PARAM_1_]], [[RES_1_]], [[RES_]]) <{layout = "3D"}> : (memref<3x4x5xf16, #map>, memref<3x4x5xf16, #map>, memref<3xi64>, memref<3x4x5xf16, #map>) -> ()
...
func.func @should_lower_to_zlow_unknown_dims(%arg0: tensor<3x?x5xf16, #zhigh.layout<{dataLayout = "3D"}>>, %arg1: tensor<3x?x5xf16, #zhigh.layout<{dataLayout = "3D"}>>) -> tensor<*xf16> {
  %0 = "zhigh.Min"(%arg0, %arg1) : (tensor<3x?x5xf16, #zhigh.layout<{dataLayout = "3D"}>>, tensor<3x?x5xf16, #zhigh.layout<{dataLayout = "3D"}>>) -> tensor<*xf16>
  return %0 : tensor<*xf16>
