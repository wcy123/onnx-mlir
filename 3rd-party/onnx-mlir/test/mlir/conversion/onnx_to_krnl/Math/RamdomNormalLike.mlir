...
func.func @test_random_normal_like2(%arg0: tensor<3x4x5xf32>) -> tensor<*xf64> {
  %0 = "onnx.RandomNormalLike"(%arg0) {dtype = 11 : si64, mean = 0.0 :f32, scale = 1.0 : f32, seed = 2.0 : f32} : (tensor<3x4x5xf32>) -> tensor<*xf64>
...
func.func @test_random_normal_like3(%arg0: tensor<3x4x5xf32>) -> tensor<*xf64> {
  %0 = "onnx.RandomNormalLike"(%arg0) {dtype = 11 : si64, mean = 0.0 :f32, scale = 1.0 : f32} : (tensor<3x4x5xf32>) -> tensor<*xf64>
  "func.return"(%0) : (tensor<*xf64>) -> ()
