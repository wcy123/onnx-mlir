...
// Initialize runtime state (creates stream, MIOpen handle, hipBLAS handle, uploads constants)
// Parameters:
...
// implementation, not interface. Generated code is allocation-strategy agnostic.
//
